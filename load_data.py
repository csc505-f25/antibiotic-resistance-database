...
df_profiles["resistance_phenotype"] = (
    df_profiles["resistance_phenotype"]
...
# Optional: standardize a few common weird values
df_profiles["resistance_phenotype"] = df_profiles["resistance_phenotype"].replace({
    "non-susceptible": "resistant",
    "non susceptible": "resistant",
    "ns": "resistant",
    "na": "",
    "nd": "",
